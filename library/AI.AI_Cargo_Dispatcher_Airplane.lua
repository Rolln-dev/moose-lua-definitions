...
---@deprecated
---@class AI_CARGO_DISPATCHER_AIRPLANE 
...
---@param DeployZoneSet SET_ZONE The set of zone airbases where the cargo is deployed. Choice for each cargo is random.
---@return AI_CARGO_DISPATCHER_AIRPLANE #self
function AI_CARGO_DISPATCHER_AIRPLANE:New(AirplaneSet, CargoSet, PickupZoneSet, DeployZoneSet) end
