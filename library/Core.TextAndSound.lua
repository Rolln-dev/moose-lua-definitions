...
---@field private entries table Table of entries.
---@field private lid string LID for log entries.
---@field private locale string Default locale of this object.
---@field private textclass string Name of the class the texts belong to.
...
---@field Data table The list of entries.
