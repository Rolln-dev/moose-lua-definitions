...
---<img src="https://flightcontrol-master.github.io/MOOSE_DOCS_DEVELOP/Images/Task_A2G_Dispatcher.JPG" width="100%">
---
...
---The detection object will group the detected targets by its grouping method, and integrates a Core.Set of Wrapper.Groups that are Recce vehicles or air units.
...
---@deprecated
---@class TASK_A2G_DISPATCHER : DETECTION_MANAGER
...
function TASK_A2G_DISPATCHER:EvaluateBAI(DetectedItem, FriendlyCoalition) end
...
---@return SET_UNIT #TargetSetUnit: The target set of units.
---@return nil #If there are no targets to be set.
function TASK_A2G_DISPATCHER:EvaluateCAS(DetectedItem) end
...
---@return TASK #
function TASK_A2G_DISPATCHER:EvaluateRemoveTask(Mission, Task, DetectedItemID, DetectedItemChange, TaskIndex, DetectedItemChanged) end
...
---@return SET_UNIT #TargetSetUnit: The target set of units.
---@return nil #If there are no targets to be set.
function TASK_A2G_DISPATCHER:EvaluateSEAD(DetectedItem) end
...
function TASK_A2G_DISPATCHER:New(Mission, SetGroup, Detection) end
...
function TASK_A2G_DISPATCHER:OnAfterAssign(From, Event, To, Task, TaskUnit, PlayerName) end
