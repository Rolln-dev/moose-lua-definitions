...
---<img src="https://flightcontrol-master.github.io/MOOSE_DOCS_DEVELOP/Images/Task_Cargo_CSAR.JPG" width="100%">
---
...
function TASK_CARGO_CSAR:New(Mission, SetGroup, TaskName, SetCargo, TaskBriefing) end
...
function TASK_CARGO_CSAR:OnAfterCargoDeployed(From, Event, To, TaskUnit, Cargo, DeployZone) end
...
---@param Cargo CARGO The Cargo that got PickedUp by the TaskUnit. You can use this to check Cargo Status.
function TASK_CARGO_CSAR:OnAfterCargoPickedUp(From, Event, To, TaskUnit, Cargo) end
